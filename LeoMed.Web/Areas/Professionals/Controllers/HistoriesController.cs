...
namespace LeoMed.Web.Areas.Professionals.Controllers
{
     ...
     public class HistoriesController : Controller
     {
          ...
          public async Task<IActionResult> Index()
          {
               ...
               return View(await db.Histories.Where(e => e.Professional.AppUser.UserName == User.Identity.Name).Include(e => e.Professional).ThenInclude(e => e.AppUser).Include(e => e.Patient).ThenInclude(e => e.AppUser).ToListAsync());
          }
